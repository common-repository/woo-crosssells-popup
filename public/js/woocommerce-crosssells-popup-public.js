/**
 * Woocommerce CrossSells Popup Frontend JavaScript
 */
...
$.fn.slick = function() {
 ...
 /* ========================================================================
 * Woocommerce CrossSells Popup JavaScript
 * ======================================================================== */

 jQuery(".open-crosssells-modal.added").initialize( function(){
 after_add_to_cart_single();  
 });

 function after_add_to_cart_single(){
  var p_id = jQuery(this).attr('data-product_id');
  if( jQuery("#CrossSellsModal-" + p_id).length ){
  jQuery("#CrossSellsModal-" + p_id).modal('show');
  jQuery('.crosssells-crousel-' + p_id).slick({
    infinite: true,
    slidesToShow: 4,
    slidesToScroll: 1,
    prevArrow: jQuery('.crosssell-prev'),
    nextArrow: jQuery('.crosssell-next'),
    responsive: [
    {
      breakpoint: 1024,
      settings: {
